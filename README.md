...
1. **Поиск** — купольная fisheye-камера в рабочем положении обзора ведёт небо (от подвесного home с наклоном вверх).
...
Камеры крепятся **подвесным монтажом** к верхней раме куба: в положении **home** оптическая ось направлена **вниз**. Для наблюдения за небом PTZ **наклоняют** камеру вверх (tilt); купольная даёт широкий обзор при рабочем угле наклона.

### Монтаж камер

<p align="center">
  <img src="docs/images/dome-camera-mount.png" alt="Купольная камера — подвесной монтаж, ось вниз" width="380">
  &nbsp;&nbsp;
  <img src="docs/images/ptz-camera-mount.png" alt="Угловая PTZ — подвесной монтаж, модуль NE" width="380">
</p>

<p align="center"><em>Слева: купольная камера. Справа: угловой модуль (пример — NE). Направление установки — вниз; наведение на цель — pan/tilt от home.</em></p>

### Вид сверху (рама куба)
...
```text
    ...
    [▼]──────────[▼]──────────[▼]     ← камеры подвешены НИЖЕ верхней грани
         [▼ купол — центр]
    PTZ и купол в одной горизонтальной плоскости крепления
```

### Вид сбоку (подвес)

```text
        ═══════════════════════   ← верхняя грань куба (рамка V-slot)
              [▼ купол]
        [▼]               [▼]     ← home: ось камеры вниз ⊥ к раме
              ║ куб ║
        [▼]               [▼]

        ···  tilt вверх  ↗        ← рабочий режим: наведение на небо
```
