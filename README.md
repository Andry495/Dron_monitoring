...
Камеры устанавливаются на верхней грани куба и в положении **home** смотрят **вверх** — на небо. Купольная даёт широкий обзор над головой; угловые PTZ отклоняются pan/tilt от вертикали к цели.

### Ориентация камер

```text
        [▲]               [▲]     ← PTZ, home: ось вверх (сектор N / E / S / W)
              [▲ купол]
        ═══════════════════════   ← верхняя грань куба (рамка)
              ║   куб   ║
        [▲]               [▲]
...
```text
              ↑ небо
         [▲]       [▲]        home: камеры смотрят вверх
              [▲]
        ═══════════════════   верхняя грань куба
              ║ куб ║

        pan/tilt ↗            отклонение к цели на горизонте
```
